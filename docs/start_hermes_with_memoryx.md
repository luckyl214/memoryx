...
| # | 检查项 | 说明 |
|---|--------|------|
| 1 | Canonical DB path | 唯一生产数据库路径 `${HOME}/memoryx/data/memoryx.db` |
...
# 修复 embedding
cd ${HOME}/memoryx
MEMORYX_DB_PATH=data/memoryx.db .venv/bin/python tools/backfill_embeddings_siliconflow.py --include-conversations
