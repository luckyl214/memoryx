...
- Started: `2026-05-23T10:31:07.824402+00:00`
- Finished: `2026-05-23T10:31:24.490870+00:00`
- Duration: `16.667s`
...
|---|---|---|---|---|
| ERROR | `pytest` | `fail` | `` | pytest failed with exit code 1. |
| ERROR | `repository_static_contract` | `fail` | `memoryx/storage/repository.py` | store_memory does not appear to use BEGIN IMMEDIATE or repository.db.transaction(). |
| ERROR | `repository_static_contract` | `fail` | `memoryx/storage/repository.py` | Repository lacks update_memory_versioned(); SelfEditor cannot preserve history reliably. |
